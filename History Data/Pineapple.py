...
class Pineapple:
    ...
    def referenceEvapotranspiration(minTemp, maxTemp, windSpeed, relativeHumidity, solarRadiation, dayOfYear):
        #windSpeed = 0.277778 #Wind speed [m s-1]
        ...
        windSpeedAt2m = windSpeed

        #Saturation Vapor Pressure
        saturationVaporPressure = fao.svp_from_t(temperature) #Saturation vapour pressure [kPa]
        
        #Actual Vapor Pressure
        actualVaporPressure = fao.avp_from_rhmean(fao.svp_from_t(minTemp),fao.svp_from_t(maxTemp), relativeHumidity) #Actual vapour pressure [kPa]
        ...
        #Medziphema : 25.7566° N, 93.8681° E
        latitude = convert.deg2rad(25.7566)
